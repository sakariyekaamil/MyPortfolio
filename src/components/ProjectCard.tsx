  ...
  return (
    ...
    >
      <div className="relative flex h-full flex-col overflow-hidden rounded-2xl border border-border bg-surface transition-colors group-hover:border-primary/35">
        ...
        <div className="relative z-10 -mt-14 mx-3 mb-3 flex flex-1 flex-col rounded-xl border border-border bg-card p-5 shadow-[0_12px_40px_rgba(0,0,0,0.35)] sm:mx-4 sm:mb-4 sm:p-6">
